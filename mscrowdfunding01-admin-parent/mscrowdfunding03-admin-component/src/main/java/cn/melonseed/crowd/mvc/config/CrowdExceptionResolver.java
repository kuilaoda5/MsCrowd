/**  
* Title: CrowdExceptionResolver.java  
* Description:   
* @author MelonSeed
* @date 2021年5月25日  
* @version 1.0  
...
import cn.melonseed.crowd.exception.LoginAcctAlreadyInUseException;
import cn.melonseed.crowd.exception.LoginAcctAlreadyInUseForUpdateException;
import cn.melonseed.crowd.exception.LoginFailedException;
...
public class CrowdExceptionResolver {
   ...
   */
	...
	public ModelAndView resolveException(Exception exception,
	    ...
	    return commonCode(exception,request,response,"admin-login");
	}
  	 //整理出的不同异常的可重用代码
